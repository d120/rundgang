...
!0;this.material.opacity=0;this.scaleUpAnimation=new r.Tween;this.scaleDownAnimation=new r.Tween;c=function(d){if(this.material){d.image.width=d.image.naturalWidth||64;d.image.height=d.image.naturalHeight||64;this.scale.set(d.image.width/d.image.height*a,a,1);var b=new e.Vector3;b.copy(this.scale);this.scaleUpAnimation=(new r.Tween(this.scale)).to({x:1.3*b.x,y:1.3*b.y},500).easing(r.Easing.Elastic.Out);this.scaleDownAnimation=(new r.Tween(this.scale)).to({x:b.x,y:b.y},500).easing(r.Easing.Elastic.Out);
